                        ...
                        {menuItems.map((item, index) => (
                            <li key={index} className="relative">
                                <a
                                    ...
                                    className={`block py-2 px-3 border-b-2 lg:border-b-0 md:border-b-0 sm:border-b-2 ${item.isActive ? 'text-white' : 'text-gray-900'}
                                                ${item.isActive ? 'md:bg-transparent md:text-blue-700' : 'md:hover:bg-transparent md:hover:text-blue-700'}
                                                md:p-0 md:dark:text-white
                                                hover:underline dark:text-white dark:hover:bg-gray-700 dark:hover:text-red-600 md:dark:hover:bg-transparent dark:border-white
                                                ${!item.isActive ? 'hover:bg-gray-200' : ''}`}
                                        ...
                                        {item.dropdownItems.map((dropdownItem, dropdownIndex) => (
                                            <li key={dropdownIndex}>
                                                <a
                                                    ...
                                                    className="block px-4 py-2 w-full border-b-2 text-gray-900 dark:text-white hover:bg-gray-100 dark:hover:bg-pink-500"
                                                >
                                                    {dropdownItem.name}
                                                </a>
                                            </li>
